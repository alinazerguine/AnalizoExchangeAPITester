...
abstract class Account implements ActiveRecordInterface
{
    ...
    public function setExchangeName($v)
    {
        ...
        if ($this->exchange_name !== $v) {
            ...
            $this->modifiedColumns[AccountTableMap::COL_EXCHANGE_NAME] = true;
        }
    ...
    public function setApiKey($v)
    {
        ...
        if ($this->api_key !== $v) {
            $this->api_key = $v;
            $this->modifiedColumns[AccountTableMap::COL_API_KEY] = true;
        }
    ...
    public function setApiSecret($v)
    {
        ...
        if ($this->api_secret !== $v) {
            $this->api_secret = $v;
            $this->modifiedColumns[AccountTableMap::COL_API_SECRET] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AccountTableMap::translateFieldName('ExchangeName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->exchange_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AccountTableMap::translateFieldName('ApiKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->api_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AccountTableMap::translateFieldName('ApiSecret', TableMap::TYPE_PHPNAME, $indexType)];
            $this->api_secret = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AccountTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_EXCHANGE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`exchange_name`';
        }
        if ($this->isColumnModified(AccountTableMap::COL_API_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`api_key`';
        }
        if ($this->isColumnModified(AccountTableMap::COL_API_SECRET)) {
            $modifiedColumns[':p' . $index++]  = '`api_secret`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`api_key`':
                        ...
                        break;
                    case '`api_secret`':
                        $stmt->bindValue($identifier, $this->api_secret, PDO::PARAM_STR);
                        break;
                    case '`uid`':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getExchangeName(),
            $keys[3] => $this->getApiKey(),
            $keys[4] => $this->getApiSecret(),
            $keys[5] => $this->getUid(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setExchangeName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setApiKey($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setApiSecret($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setUid($arr[$keys[5]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_EXCHANGE_NAME)) {
            $criteria->add(AccountTableMap::COL_EXCHANGE_NAME, $this->exchange_name);
        }
        if ($this->isColumnModified(AccountTableMap::COL_API_KEY)) {
            $criteria->add(AccountTableMap::COL_API_KEY, $this->api_key);
        }
        if ($this->isColumnModified(AccountTableMap::COL_API_SECRET)) {
            $criteria->add(AccountTableMap::COL_API_SECRET, $this->api_secret);
        }
        if ($this->isColumnModified(AccountTableMap::COL_UID)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setApiSecret($this->getApiSecret());
