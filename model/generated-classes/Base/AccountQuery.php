 ...
 * @method     ChildAccountQuery orderByExchangeName($order = Criteria::ASC) Order by the exchange_name column
 * @method     ChildAccountQuery orderByApiKey($order = Criteria::ASC) Order by the api_key column
 * @method     ChildAccountQuery orderByApiSecret($order = Criteria::ASC) Order by the api_secret column
 ...
 * @method     ChildAccountQuery groupByExchangeName() Group by the exchange_name column
 * @method     ChildAccountQuery groupByApiKey() Group by the api_key column
 * @method     ChildAccountQuery groupByApiSecret() Group by the api_secret column
 ...
 * @method     ChildAccount findOneByExchangeName(string $exchange_name) Return the first ChildAccount filtered by the exchange_name column
 * @method     ChildAccount findOneByApiKey(string $api_key) Return the first ChildAccount filtered by the api_key column
 * @method     ChildAccount findOneByApiSecret(string $api_secret) Return the first ChildAccount filtered by the api_secret column
 ...
 * @method     ChildAccount requireOneByExchangeName(string $exchange_name) Return the first ChildAccount filtered by the exchange_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAccount requireOneByApiKey(string $api_key) Return the first ChildAccount filtered by the api_key column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAccount requireOneByApiSecret(string $api_secret) Return the first ChildAccount filtered by the api_secret column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildAccount[]|ObjectCollection findByExchangeName(string $exchange_name) Return ChildAccount objects filtered by the exchange_name column
 * @method     ChildAccount[]|ObjectCollection findByApiKey(string $api_key) Return ChildAccount objects filtered by the api_key column
 * @method     ChildAccount[]|ObjectCollection findByApiSecret(string $api_secret) Return ChildAccount objects filtered by the api_secret column
...
abstract class AccountQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'analizoexchangeapitester', $modelName = '\\Account', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `exchange_name`, `api_key`, `api_secret`, `uid` FROM `account` WHERE `id` = :p0';
        try {
    ...
    public function filterByExchangeName($exchangeName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AccountTableMap::COL_EXCHANGE_NAME, $exchangeName, $comparison);
    }
    ...
    public function filterByApiKey($apiKey = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AccountTableMap::COL_API_KEY, $apiKey, $comparison);
    }

    /**
     * Filter the query on the api_secret column
     *
     * Example usage:
     * <code>
     * $query->filterByApiSecret('fooValue');   // WHERE api_secret = 'fooValue'
     * $query->filterByApiSecret('%fooValue%', Criteria::LIKE); // WHERE api_secret LIKE '%fooValue%'
     * </code>
     *
     * @param     string $apiSecret The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildAccountQuery The current query, for fluid interface
     */
    public function filterByApiSecret($apiSecret = null, $comparison = null)
    {
        if (null === $comparison) {
        ...
        return $this->addUsingAlias(AccountTableMap::COL_API_SECRET, $apiSecret, $comparison);
    }
