...
class AccountTableMap extends TableMap
{
     ...
     */
    const COL_EXCHANGE_NAME = 'account.exchange_name';

    /**
     * the column name for the api_key field
     */
    const COL_API_KEY = 'account.api_key';

    /**
     * the column name for the api_secret field
     */
    const COL_API_SECRET = 'account.api_secret';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'ExchangeName', 'ApiKey', 'ApiSecret', 'Uid', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'exchangeName', 'apiKey', 'apiSecret', 'uid', ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID, AccountTableMap::COL_NAME, AccountTableMap::COL_EXCHANGE_NAME, AccountTableMap::COL_API_KEY, AccountTableMap::COL_API_SECRET, AccountTableMap::COL_UID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'exchange_name', 'api_key', 'api_secret', 'uid', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'ExchangeName' => 2, 'ApiKey' => 3, 'ApiSecret' => 4, 'Uid' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'exchangeName' => 2, 'apiKey' => 3, 'apiSecret' => 4, 'uid' => 5, ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID => 0, AccountTableMap::COL_NAME => 1, AccountTableMap::COL_EXCHANGE_NAME => 2, AccountTableMap::COL_API_KEY => 3, AccountTableMap::COL_API_SECRET => 4, AccountTableMap::COL_UID => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'exchange_name' => 2, 'api_key' => 3, 'api_secret' => 4, 'uid' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('api_secret', 'ApiSecret', 'VARCHAR', false, 255, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AccountTableMap::COL_EXCHANGE_NAME);
            $criteria->addSelectColumn(AccountTableMap::COL_API_KEY);
            $criteria->addSelectColumn(AccountTableMap::COL_API_SECRET);
            ...
            $criteria->addSelectColumn($alias . '.api_secret');
